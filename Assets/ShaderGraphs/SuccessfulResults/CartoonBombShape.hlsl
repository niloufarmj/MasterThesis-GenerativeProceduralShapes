...
// ------------------------------------------------------------------------
//  This function generates a **stylized 2D cartoon bomb icon**
//  using Signed Distance Functions (SDFs).
//
//  The visual result features a rounded spherical body with a short
//  connector at the top, from which a curved fuse extends outward.
//  A small star-shaped spark appears at the end of the fuse, and a
//  subtle circular highlight may be present on the body to suggest
//  a glossy, cartoon-like material.
//
//  The overall proportions, fuse curvature, spark appearance,
//  highlight strength, orientation, scale, color composition, and
//  layering are fully controlled by input parameters and are not
//  fixed by the function itself.
//
//  The output is an anti-aliased RGBA color suitable for playful
//  icons, game UI elements, warning symbols, and expressive
