...
// ------------------------------------------------------------------------
//  This function generates a **stylized 2D cartoon flame** using
//  Signed Distance Functions (SDFs).
//
//  The visual result is composed of:
//  - A central fire body that transitions from a rounded base to a jagged,
//    wavy top edge using polar coordinate distortion.
//  - Multiple flame tips generated by a cosine wave, where the count and
//    sharpness of the tips are adjustable.
//  - A global curvature deformation that bends the entire flame to simulate
//    wind or movement.
//  - Three concentric color layers (Inner, Middle, Outer) defined by
//    internal distance thresholds.
//
//  The rendering blends these layers from hot core to cool outer edge,
//  finished with a consistent outline. The output is an anti-aliased RGBA
//  color suitable for torches, campfires, and magical effects.
// ------------------------------------------------------------------------