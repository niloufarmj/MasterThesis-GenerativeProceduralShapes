...
// ------------------------------------------------------------------------
//  This function generates a **stylized 2D cartoon bell icon**
//  using Signed Distance Functions (SDFs).
//
//  The visual result is a bell-shaped silhouette composed of a smooth,
//  rounded upper dome blended into a flared lower body. A separate
//  circular clapper element appears beneath the bell opening, partially
//  occluded by the bell body to create a layered, cartoon-like look.
//  An optional outline surrounds both the bell body and clapper,
//  emphasizing the icon style.
//
//  The overall proportions, bell curvature, flare width, clapper size,
//  outline thickness, color composition, scale, placement, and visual
//  styling are fully controlled by input parameters and are not fixed
//  by the function itself.
//
//  The output is an anti-aliased RGBA color suitable for notification
//  icons, alert symbols, UI elements, and expressive procedural
//  2D graphics.
// ------------------------------------------------------------------------
