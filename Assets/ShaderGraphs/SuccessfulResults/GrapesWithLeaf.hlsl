...
// ------------------------------------------------------------------------
//  This function generates a **stylized 2D bunch-of-grapes icon with a leaf**
//  using Signed Distance Functions (SDFs).
//
//  The visual result consists of multiple circular grape shapes arranged
//  in a compact cluster, forming a classic bunch-of-grapes silhouette.
//  Above the grape cluster, a thin stem extends upward and connects to
//  a single leaf shape, creating a clear separation between fruit and
//  foliage elements.
//
//  The number of grapes, their relative spacing and size, the stem length
//  and thickness, the leaf size, curvature, rotation, color composition,
//  scale, and placement are fully controlled by input parameters and are
//  not fixed by the function itself.
//
//  The output is an anti-aliased RGBA color suitable for food icons,
//  agricultural symbols, decorative UI elements, and expressive procedural
//  2D graphics.
// ------------------------------------------------------------------------
