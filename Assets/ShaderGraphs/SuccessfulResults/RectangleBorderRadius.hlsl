...
// ------------------------------------------------------------------------
//  This function generates a **2D rounded-rectangle primitive with optional
//  border (outline)** using Signed Distance Functions (SDFs).
//
//  The shape consists of a rectangular form with smoothly rounded corners,
//  supporting both a filled interior and a surrounding border region.
//  The rectangle’s dimensions, corner curvature, orientation, placement,
//  fill color, and border appearance are fully controlled by input
//  parameters and are not fixed by the function itself.
//
//  The output is an anti-aliased RGBA color suitable for UI panels,
//  buttons, containers, cards, and analytic procedural 2D graphics.
// ------------------------------------------------------------------------
