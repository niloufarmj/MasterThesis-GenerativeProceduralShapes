...
// ------------------------------------------------------------------------
//  This function generates a **2D potted cactus illustration** created using analytic shapes. The resulting image consists of:
//
//  - A trapezoidal container with a distinguishable upper lip.
//  - Three curving, almond-shaped cactus segments positioned vertically, representing the center and two side arms.
//  - A series of accented lines and small thorns scattered on the cactus surface, adding texture.
//  - Stylized flower shapes with rounded petals and circular centers adorning each cactus segment.
//
//  The composition is smoothly integrated to form a cohesive and organic depiction of a potted cactus.
// ------------------------------------------------------------------------
