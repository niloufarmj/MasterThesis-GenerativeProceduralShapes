...
// ------------------------------------------------------------------------
//  This function produces a **2D cartoon technical mannequin figure** assembled from geometric shapes. The figure features a circular head, positioned at the top, sitting on a narrow rectangular neck. Below the neck is a wide rectangular torso, which is connected to a slightly wider rectangular pelvis. Two small circles act as shoulder joints, positioned symmetrically at the top sides of the torso. The arms consist of rectangular segments: an upper arm stemming from each shoulder, ending in a circular elbow joint, followed by a lower arm segment, and a small rectangular hand. The legs start with rectangular upper leg segments extending from circular hip joints, ending with circular knee joints followed by lower leg segments, and finishing with a short rectangular foot. All joint connections are visibly marked with circles, adding to the clean, geometric appearance of the figure.
// ------------------------------------------------------------------------
