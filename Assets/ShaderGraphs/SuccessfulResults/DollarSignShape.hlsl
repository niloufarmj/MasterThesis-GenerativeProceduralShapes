...
// ------------------------------------------------------------------------
//  This function generates a **stylized 2D dollar-sign ($) primitive**
//  using Signed Distance Functions (SDFs).
//
//  The visual result forms a bold monetary symbol composed of a smooth,
//  continuous S-shaped curve intersected by a straight vertical bar.
//  The curved portions are rounded and evenly weighted, producing a
//  clean, icon-like silhouette suitable for small-scale rendering.
//
//  The overall size, stroke thickness, curvature, vertical bar width,
//  placement, scale, and color are fully controlled by input parameters
//  and are not fixed by the function itself.
//
//  The output is an anti-aliased RGBA color suitable for currency icons,
//  financial indicators, UI symbols, and analytic procedural 2D graphics.
// ------------------------------------------------------------------------
