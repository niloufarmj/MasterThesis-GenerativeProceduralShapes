...
// ------------------------------------------------------------------------
//  This function generates a **stylized 2D cartoon padlock primitive**
//  using Signed Distance Functions (SDFs).
//
//  The visual result consists of a rounded rectangular lock body and a
//  smooth U-shaped shackle emerging from the top of the body. The shackle
//  is partially embedded into the body, creating a layered appearance
//  where the body visually overlaps the shackle legs. The overall design
//  emphasizes soft corners and clean silhouettes typical of cartoon-style
//  icons.
//
//  The body dimensions, corner roundness, shackle curvature, shackle
//  thickness, relative positioning, color composition, scale, and
//  placement are fully controlled by input parameters and are not fixed
//  by the function itself.
//
//  The output is an anti-aliased RGBA color suitable for security icons,
//  UI elements, access indicators, and expressive procedural 2D graphics.
// ------------------------------------------------------------------------
