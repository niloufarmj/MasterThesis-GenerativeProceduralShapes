...
// ------------------------------------------------------------------------
//  This function generates a **stylized 2D flag-on-a-pole icon**
//  using Signed Distance Functions (SDFs) with domain distortion.
//
//  The visual result consists of a vertical rectangular pole and a
//  horizontally extended flag attached near the top of the pole.
//  The flag body exhibits a smooth, wavy silhouette created through
//  sinusoidal deformation, giving the appearance of fabric fluttering
//  in the wind. The pole and flag are rendered as separate layered
//  components, with the pole visually overlapping the flag at the
//  attachment point.
//
//  The pole height and thickness, flag size, wave frequency, wave
//  amplitude, wave phase, color composition, scale, and placement
//  are fully controlled by input parameters and are not fixed by the
//  function itself.
//
//  The output is an anti-aliased RGBA color suitable for markers,
//  navigation symbols, status indicators, UI icons, and expressive
