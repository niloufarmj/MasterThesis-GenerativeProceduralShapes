...
// ------------------------------------------------------------------------
//  This function produces a **2D cartoon acorn** constructed from analytic SDFs. The resulting shape is composed of:
//
//  - A smooth, rounded nut body with an adjustable teardrop or oval shape.
//  - A textured cap covering the upper section of the nut, featuring a diagonal crisscross lattice pattern creating diamond-shaped scales.
//  - A small, pointed stem protruding from the top center of the cap.
//  - Optional glossy highlight reflections on the nut body to suggest a polished surface.
//  - Distinct adjustable colors are used for the nut body and cap to enhance the flat 2D cartoon style.
// ------------------------------------------------------------------------
