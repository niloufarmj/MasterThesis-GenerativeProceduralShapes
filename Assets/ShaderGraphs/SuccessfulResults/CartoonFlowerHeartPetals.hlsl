...
// ------------------------------------------------------------------------
//  This function generates a **stylized 2D cartoon flower with heart-shaped
//  petals** using Signed Distance Functions (SDFs).
//
//  The visual result consists of multiple heart-shaped petal forms arranged
//  radially around a central circular core, forming a playful floral
//  silhouette. Each petal points outward from the center, and the overall
//  flower is surrounded by a clean, continuous outline that encloses both
//  the petals and the center.
//
//  The number of petals, their size, radial spread, rotation, the size of
//  the center circle, outline thickness, color composition, scale, and
//  placement are fully controlled by input parameters and are not fixed by
//  the function itself.
//
