...
void SimpleTriangle_float(float2 UV, float2 Position, float Size, float Rotation, float4 Color, out float4 outColor)
{
    ...
    float2 v1 = float2(r * 0.86602540378, -r * 0.5);
    float2 v2 = float2(-r * 0.86602540378, -r * 0.5);
