    ...
    public static class ImageToShaderPipelineManager
    {
            ...
            int  pixelCount      = 50)
        {
            ...
            try
            {
                ...
                string description = await LLMApiService.CallOpenAIDescribeImageAsync(
            ...
            string openAIKey)
        {
            ...
            try
            {
                refUrl     = LLMApiService.ImageToResizedBase64Public(referenceAbsPath, 256);
                previewUrl = LLMApiService.ImageToResizedBase64Public(previewAbsPath,   256);
            }
            catch (Exception ex)
            {
